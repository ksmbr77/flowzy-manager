      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {differentials.map((item, index) => {
            ...
            return (
              <AnimatedSection key={index} delay={index * 150} animation="scale-in" className="relative group">
        ...
        <AnimatedSection delay={600} className="mt-8 sm:mt-12 lg:mt-16 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
